...
\title{Paquete de Python para el Procesamiento de Im\'agenes Usando Varios Modelos no Lineales}
\author{\\\vspace{0.25cm}Carlos Toledo Silva}
\advisor{\\\vspace{0.25cm}MSc. Damian Vald\'es Santiago}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{25 de noviembre de 2022\\\vspace{0.25cm}\href{https://github.com/CTS-crypto/Logarithmic-Image-Processing}{https://github.com/CTS-crypto/Logarithmic-Image-Processing}}
