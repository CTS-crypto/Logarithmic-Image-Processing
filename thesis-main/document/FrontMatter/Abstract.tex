...
\begin{abstract}
	This paper analyzes the main nonlinear models for image processing proposed to date and their properties. Those addressed here are:
