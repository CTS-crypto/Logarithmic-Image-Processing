...
\begin{table}
	\begin{center}
		\begin{tabular}{|l|l|l|}
			...
			\hline
		\end{tabular}
		\caption{Media y mediana del valor de $C_p$ para el algoritmo \textins{unsharp masking} utilizando los diferentes modelos en im\'agenes naturales}
	\end{center}
\end{table}
...
\begin{table}
	\begin{center}
		\begin{tabular}{|l|l|l|}
			...
			\hline
		\end{tabular}
		\caption{Media y mediana del valor de $C_p$ para el algoritmo \textins{unsharp masking} utilizando los diferentes modelos en im\'agenes de radiograf\'ias de t\'orax}
	\end{center}
\end{table}
