...
Ahora analicemos la ecuación (1.2). Mientras que $u$ puede ser cualquier elemento del conjunto de entrada finito $E$ , $\alpha$ es, típicamente, un escalar real positivo $(K=\mathbb{R}^+)$.
...
En el conjunto de tonos de gris $E$ definiremos la suma $\oplus$ y la multiplicación escalar real $\otimes$.
